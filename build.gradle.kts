...
dependencies {
    ...
    modImplementation("com.github.sib-energy-craft:mod-tools-impl:${project.property("sec_mod_tools_impl_version")}")
    modImplementation("com.github.sib-energy-craft:mod-recipes:${project.property("sec_mod_recipes_version")}")
}
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/sib-energy-craft/mod-rubber"
                ...
                scm {
                    connection.set("scm:https://github.com/sib-energy-craft/mod-rubber.git")
                    developerConnection.set("scm:git:ssh://github.com/sib-energy-craft")
                    url.set("https://github.com/sib-energy-craft/mod-rubber")
                }
    ...
    repositories {
        ...
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/sib-energy-craft/mod-rubber")
            credentials {
